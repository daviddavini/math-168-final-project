...
# for each time (of the 288), find the correlation between the speed and the degree centrality
...
def correlations_by_time_of_day(centrality, centrality_name, filename):
    ...
    plot_quantity_over_24_hours(p_values, "P-value", "P-values for correlation between speed and {} vs time of day".format(centrality_name), filename.replace(".png", "_p_values.png"), vertical_lines=vertical_lines)
